...
%>
                   ...
                   <tbody>
                    <tr>
                     ...
                     <td> <a href = "entry/order/generateUpdateForm?orderid=<%=resultSet.getString("orderid")%>">Update</a></td> 
                     <td> <a href = "entry/order/deactivate?orderid=<%=resultSet.getString("orderid")%>">Delete</a></td> 
                      <td> <a href = "AddPayment.jsp">Payment Settings</a></td> 
